...
def load_e63_state_for_brain(root: Path | None = None) -> dict:
    return core.load_e63_state_for_brain(root or core.BRIDGE_ROOT)
...
def write_ceo_brain_readback_smoke(output_root: Path | None = None) -> dict:
    ...
    core.write_json(root, "operations/external_validation/e63_ceo_brain_readback_smoke_result.json", data)
    return data
