...
def build_ceo_kg_frontier_import_reconciliation_feedback() -> dict[str, Any]:
    """Return the E41 artifact and keep a stable code-level entry point."""
    artifact = get_artifact("e41_ceo_kg_frontier_import_reconciliation_feedback")
    return artifact


def forbidden_action_flags(artifact: dict[str, Any] | None = None) -> dict[str, bool]:
    artifact = artifact or build_ceo_kg_frontier_import_reconciliation_feedback()
    keys = [
