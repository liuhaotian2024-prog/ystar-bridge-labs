...
- asset-0611: console_read_model/generated/team_console_snapshot.md (B_wrap_as_governed_tool)
- asset-1097: gov_mcp/server.py (B_wrap_as_governed_tool)
- asset-4358: scripts/skill_lifecycle_manager.py (B_wrap_as_governed_tool)
- asset-3385: reports/ceo/demonstrators/goal_4_ystar_symbol_liveness.py (B_wrap_as_governed_tool)
