...
def build_l6_12_unified_controlled_observation_summary(
    milestone_summary: dict[str, Any] | None,
    ...
    conflict_registry: dict[str, Any] | None,
    refinement_index: dict[str, Any] | None,
    capability_gap_registry: dict[str, Any] | None,
    ...
    if not readiness_summary:
        return {
            "schema_name": "ystar.console_read_model.generated.l6_12_unified_controlled_external_observation_evidence_loop_summary",
            "schema_version": "v0",
            "l6_12_unified_controlled_external_observation_evidence_loop_complete": False,
            "warning": "L6.12 unified controlled observation loop pack has not been generated yet.",
        }
    ...
    conflict_registry = conflict_registry or {}
    refinement_index = refinement_index or {}
    capability_gap_registry = capability_gap_registry or {}
    ...
    return {
        "schema_name": "ystar.console_read_model.generated.l6_12_unified_controlled_external_observation_evidence_loop_summary",
        "schema_version": "v0",
        "milestone_id": milestone_summary.get("milestone_id", "L6.12"),
        "milestone_name": milestone_summary.get(
            "milestone_name",
            "Unified Controlled External Observation Activation & Evidence Loop Sprint v0",
        ),
        "mode": milestone_summary.get(
        ...
        "l6_12_unified_controlled_external_observation_evidence_loop_complete": readiness_summary.get(
        ...
        "fixture_proof_executed": milestone_summary.get(
            "fixture_proof_executed", run_trace.get("fixture_proof", {}).get("fixture_proof_executed")
        ),
        ...
        "pages_opened": milestone_summary.get("pages_opened", crawl_trace.get("pages_opened", 0)),
        "domains_touched": milestone_summary.get(
            "domains_touched", crawl_trace.get("domains_touched", 0)
        ),
        "crawl_depth_used": milestone_summary.get(
            "crawl_depth_used", crawl_trace.get("crawl_depth_used", 0)
        ),
        ...
        "capability_gaps_generated": milestone_summary.get(
            "capability_gaps_generated", capability_gap_registry.get("gap_count", 0)
        ),
        ...
        "search_snippets_used_as_evidence": milestone_summary.get(
            "search_snippets_used_as_evidence", search_trace.get("snippets_used_as_evidence", False)
        ),
        ...
        "remaining_residual": residual_delta.get("primary_residual"),
        "next_step": readiness_summary.get("next_step"),
        "ask_user_for_url_authorized": flag("ask_user_for_url_authorized"),
        "user_manual_url_provision_required": flag("user_manual_url_provision_required"),
        "login_authorized": flag("login_authorized"),
        ...
        "warning": (
            "L6.12 runs a complete fixture-proven controlled observation loop and "
            "keeps real public observation gated by explicit backend/page-read "
            "configuration and safety preflight."
        ),
    }
...
def build() -> tuple[list[str], list[str], list[str], list[str]]:
    ...
    l6_12_milestone_summary = load_optional_json(
        "l6_unified_controlled_external_observation_evidence_loop/l6_12_summary.json",
        files_read,
    )
    l6_12_run_trace = load_optional_json(
        "controlled_observation_orchestrator/observation_loop_run_trace.json",
        files_read,
    )
    l6_12_query_plan = load_optional_json(
        "controlled_query_execution/generated_query_plan.json",
        files_read,
    )
    l6_12_search_trace = load_optional_json(
        "controlled_query_execution/search_execution_trace.json",
        files_read,
    )
    l6_12_crawl_trace = load_optional_json(
        "controlled_bounded_crawl/bounded_crawl_trace.json",
        files_read,
    )
    l6_12_evidence_index = load_optional_json(
        "controlled_evidence_packets/evidence_packet_index.json",
        files_read,
    )
    l6_12_conflict_registry = load_optional_json(
        "controlled_corroboration_conflict/conflict_registry.json",
        files_read,
    )
    l6_12_refinement_index = load_optional_json(
        "controlled_query_refinement/query_refinement_candidate_index.json",
        files_read,
    )
    l6_12_capability_gap_registry = load_optional_json(
        "controlled_capability_gap_report/capability_gap_registry.json",
        files_read,
    )
    l6_12_no_side_effect_receipt = load_optional_json(
        "controlled_no_action_receipts/no_side_effect_receipt.json",
        files_read,
    )
    l6_12_residual_delta = load_optional_json(
        "l6_12_read_model/l6_12_strategic_residual_delta.json",
        files_read,
    )
    l6_12_readiness_summary = load_optional_json(
        "l6_12_read_model/l6_12_readiness_assessment.json",
        files_read,
    )
    ...
    l6_12_unified_controlled_observation_summary = (
        build_l6_12_unified_controlled_observation_summary(
            l6_12_milestone_summary,
            l6_12_run_trace,
            l6_12_query_plan,
            l6_12_search_trace,
            l6_12_crawl_trace,
            l6_12_evidence_index,
            l6_12_conflict_registry,
            l6_12_refinement_index,
            l6_12_capability_gap_registry,
            l6_12_no_side_effect_receipt,
            l6_12_residual_delta,
...
def render_snapshot_markdown(snapshot: dict[str, Any], readiness: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            f"- l6_12_unified_controlled_external_observation_evidence_loop_complete: {l6_12_unified_controlled_observation.get('l6_12_unified_controlled_external_observation_evidence_loop_complete')}",
            f"- mode: {l6_12_unified_controlled_observation.get('mode')}",
            f"- run_classification: {l6_12_unified_controlled_observation.get('run_classification')}",
            f"- selected_work_order_id: {l6_12_unified_controlled_observation.get('selected_work_order_id')}",
            f"- backend_mode: {l6_12_unified_controlled_observation.get('backend_mode')}",
            f"- page_read_mode: {l6_12_unified_controlled_observation.get('page_read_mode')}",
            f"- network_allowed: {l6_12_unified_controlled_observation.get('network_allowed')}",
            f"- safety_preflight_decision: {l6_12_unified_controlled_observation.get('safety_preflight_decision')}",
            f"- fixture_proof_executed: {l6_12_unified_controlled_observation.get('fixture_proof_executed')}",
            f"- real_observation_executed: {l6_12_unified_controlled_observation.get('real_observation_executed')}",
            f"- query_count: {l6_12_unified_controlled_observation.get('query_count')}",
            f"- search_results_considered: {l6_12_unified_controlled_observation.get('search_results_considered')}",
            f"- pages_opened: {l6_12_unified_controlled_observation.get('pages_opened')}",
            f"- domains_touched: {l6_12_unified_controlled_observation.get('domains_touched')}",
            f"- crawl_depth_used: {l6_12_unified_controlled_observation.get('crawl_depth_used')}",
            f"- external_reads_used: {l6_12_unified_controlled_observation.get('external_reads_used')}",
            f"- evidence_packets_generated: {l6_12_unified_controlled_observation.get('evidence_packets_generated')}",
            f"- conflicts_found: {l6_12_unified_controlled_observation.get('conflicts_found')}",
            f"- unresolved_claims: {l6_12_unified_controlled_observation.get('unresolved_claims')}",
            f"- query_refinement_candidates_generated: {l6_12_unified_controlled_observation.get('query_refinement_candidates_generated')}",
            f"- capability_gaps_generated: {l6_12_unified_controlled_observation.get('capability_gaps_generated')}",
            f"- blockers: {l6_12_unified_controlled_observation.get('blockers')}",
            f"- ask_user_for_url_occurred: {l6_12_unified_controlled_observation.get('ask_user_for_url_occurred')}",
            f"- external_side_effects_occurred: {l6_12_unified_controlled_observation.get('external_side_effects_occurred')}",
            f"- core_writeback_occurred: {l6_12_unified_controlled_observation.get('core_writeback_occurred')}",
            f"- search_snippets_used_as_evidence: {l6_12_unified_controlled_observation.get('search_snippets_used_as_evidence')}",
