...
### 测试基线
- `reports/platform/test_coverage_baseline_20260423.md` — Ryan baseline 53% coverage / 99 failing tests / top 3 gaps (metalearning 27% / prefill 31% / dimensions 58%)
- TODO 解冻后: triage memo + 修 99 failing + 补 27pt coverage to 80%
