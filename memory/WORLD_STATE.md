...
**Unclassified**: 2599 events (routine ops / K9 routing)
...
|------|-------------|-----------|
| **M-1** | Survivability (schema/wire/config drift) | 251 |
...
**Top 5 Event Types**:
- `SESSION_JSON_SCHEMA_VIOLATION`: 195
