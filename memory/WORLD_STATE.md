...
|----------|-----------|-------------|
| amendment_coverage_audit | 219 | v (avg 345.1/d) |
...
**Top 5 Event Types**:
- `SESSION_JSON_SCHEMA_VIOLATION`: 191
- `CANONICAL_HASH_DRIFT`: 28
- `DIRECTIVE_LIVENESS_EVAL`: 28
- `WIRE_BROKEN`: 28

**Overall drift**: v (24h=275, 7d avg/day=1699.0)
