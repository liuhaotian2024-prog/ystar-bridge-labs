...
def test_ecosystem_alignment_documents_read_only_cross_repo_use():
    data = json.loads((ROOT / "operations/external_validation/e31_ecosystem_alignment_gate.json").read_text())
