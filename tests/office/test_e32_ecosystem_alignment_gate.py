...
def test_ecosystem_alignment_gate_keeps_gov_mcp_readonly():
    data = json.loads((ROOT / "operations/external_validation/e32_ecosystem_alignment_gate.json").read_text())
