#!/usr/bin/env python3
"""
Smoke test for ForgetGuard rule: defer_language_in_echo
...
def test_defer_language_in_echo_violation():
    """Smoke test: defer_language_in_echo rule fires on trigger keyword."""
    ...
    # assert violation["rule_id"] == "defer_language_in_echo"
...
@pytest.mark.skip(reason="AMENDMENT-021: rule retired 2026-04-20")
def test_defer_language_in_echo_no_violation():
    """Negative test: valid input should NOT trigger defer_language_in_echo."""
    context = {
        "agent_id": "ceo",
        "action_type": "tool_use",
