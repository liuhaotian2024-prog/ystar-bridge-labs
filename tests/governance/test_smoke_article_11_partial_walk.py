#!/usr/bin/env python3
"""
Smoke test for ForgetGuard rule: article_11_partial_walk
...
def test_article_11_partial_walk_violation():
    """Smoke test: article_11_partial_walk rule fires on trigger keyword."""
    ...
    # assert violation["rule_id"] == "article_11_partial_walk"

    # Placeholder assertion
    assert True, "Smoke test template — implement real check_forget_violation call"


def test_article_11_partial_walk_no_violation():
    """Negative test: valid input should NOT trigger article_11_partial_walk."""
    context = {
        "agent_id": "ceo",
        "action_type": "tool_use",
