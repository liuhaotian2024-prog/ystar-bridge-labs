...
**核心假设**：这个指令成功的前提假设是什么，列1-3条。

**跨维度观察**（可选）：如果注意到其他角色维度的风险，在这里标注。

**结论**：无异议继续执行 / 有异议建议调整 / 有异议请求Board重新评估
...
## 第十一条：Autonomous Mission 方法论 (Board directive, 2026-04-10)

**Autonomous Mission 是 Board 给定目标，agent 自主构建完成该目标所需的
全部认知和执行体系的任务类型。Board 只定义结果，agent 自己推导路径。
这是最高级别的自主，要求 agent 在执行前完成完整的认知建构，在执行中
持续学习，在观察后主动迭代。**

### 阶段一：认知建构（执行前，必须完成并经 Board 批准）

**第 0 层：意义建构**
- 这个 Mission 为什么重要？和公司整体战略如何连接？
- 如果成功，对公司意味着什么？如果失败，代价是什么？

**第 1 层：目标澄清**
- Board 给的目标是什么？拆解成可测量的阶段性指标
- 例："一个月 100 万完播"→ 第一周建框架完成 2 期试播 → 第二周
  调整完播率 >30% → 第三周扩大分发单期 >10 万 → 第四周冲刺总量

**第 2 层：假设显式化**
- 我认为这个目标可以达到，因为[假设 A、B、C]
- 每个假设的验证方法是什么？
- 哪些假设如果错了会导致整个计划失败？

**第 3 层：理论校准**
- 这个 Mission 涉及哪些核心动词？每个动词对应最近的理论？
- 例："冒犯了 AI"涉及：传播（扩散理论、信息缺口理论）、内容
  （叙事学、注意力经济学）、增长（病毒传播模型、网络效应理论）、
  平台（算法推荐机制、完播率模型）

**第 4 层：Benchmark**
- 历史上最接近这个目标的成功案例是什么？关键决策？数据量级？
- 失败案例的根因是什么？

**第 5 层：相关性过滤**
- 哪些案例真正适合我们？本质差异？不能照搬的部分？

**第 6 层：案例提炼**
- 从所有案例里抽取可复用的决策模式，形成 Mission 专属方法论

**第 7 层：能力边界**
- 我能独立完成什么？需要 Ethan 帮助的？需要 Board 授权的？
- 明确说明：我现在没有能力做到的部分
...
**定量观察**：收集所有可获取的平台数据，对照第 1 层阶段性指标
逐条判定达到/未达到 + 具体数字。

**定性观察**：受众的真实反应是什么？平台算法的实际表现？发现了
哪些认知框架里没有预料到的现象？

**假设验证**：第 2 层的每个假设现在验证状态如何？已验证 / 已证伪
/ 仍未知。**证伪的假设是最重要的信息**。
...
- 连续 2 个周期指标未达标
- 发现了重要的假设被证伪
- 外部环境出现重大变化（平台规则 / 热点事件）
- Board 主动要求重新校准

**迭代流程**：
1. 用新数据更新认知框架——哪些理论被验证？需要修正？有更适合的？
2. 修正假设层——删除证伪假设，提出新假设
3. 更新 Benchmark——把自己的执行经历写入 knowledge 库，自己成为
   下一个可参考案例
4. 调整执行框架——下一周期基于更新后的认知，不是重复，是螺旋上升
5. **如果多次迭代仍未达标**：主动上报 Board——需要什么资源/授权/
   或建议停止 Mission。**不允许无声继续失败**。

### 来源 (第十一条)

Board 2026-04-10 Autonomous Mission + 伦理边界 directive。
前置依赖：`governance/ETHICS.md`（所有发布前伦理检查的对照源）。
配套权限定义见 `governance/INTERNAL_GOVERNANCE.md` Autonomous Mission 章节。
